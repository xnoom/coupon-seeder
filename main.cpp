...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "coupon-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed1.easyio.tech", "dnsseed2.easyio.tech", ""};
static const string testnet_seeds[] = {"testnet-dnsseed1.easyio.tech", "testnet-dnsseed1.easyio.tech", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("seed.coupon.network", 44598), true);
  }
  do {
